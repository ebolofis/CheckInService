function CustomSignalR() {
    ...
    function GetFromMobile(String1) {
        var urlAddress = sig.api + "api/MainActions/GetFromMobile/" + sig.hotelID + "/" + String1 + "/0";
        $.ajax({
            url: urlAddress,
            cache: false,
            type: "GET",
            ...
            statusCode: {
                200: function (response) {
                    if (response != null) {
                        ...
                        var customer = new FastCheckInCustomerModel(response.FormFastCheckInModel);
                        var baseinfo = {};
                        baseinfo.HotelId = response.HotelId;
                        baseinfo.Mode = response.Mode;
                        baseinfo.Group = response.Group;
                        baseinfo.Count = response.Count;
                        ...
                        //sig.customer.notifySubscribers();
                    }
                    else {
