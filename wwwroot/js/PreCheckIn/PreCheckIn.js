function PreCheckInViewModel() {
    ...
    self.SearchCustomerByName = function () {
        ...
        reservationInfo.Arrival = moment(self.arrivalDateInputInput, "DD/MM/YYYY").format();//moment(self.arrivalDateInput()).format("DD/MM/YYYY");
        reservationInfo.Departure = moment(self.departureDateInputInput, "DD/MM/YYYY").format();//moment(self.departureDateInput()).format("DD/MM/YYYY");
